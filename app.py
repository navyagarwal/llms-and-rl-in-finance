...
# #         st.subheader("Comparison of Confusion Matrices and Classification Reports")
...
#         st.subheader("Comparison of Files")

#         for comparison in comparison_data:
#             # Display the file name as a header
#             st.markdown(f"### File: {comparison['file_name']}")

#             # Display confusion matrix and classification report under the file name
